...
6. [Portable LLM routing](docs/llm-routing.md) — an optional, credential-free package for bounded routing utilities.
7. [Support and services](docs/support-and-services.md) — a transparent, low-risk support offer and activation checklist.
